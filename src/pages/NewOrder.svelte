...
<section class="mb-5">
  <h3 class="text-center font-fatface text-3xl">Order a custom cake</h3>
  <p class="text-center">
    ...
    <AlertDialog.Root>
      <AlertDialog.Trigger>
        <Button size="lg" type="submit">
          <span class="mr-2 font-bold">Order</span>
          <Check />
        </Button>
      </AlertDialog.Trigger>
      <AlertDialog.Content>
        <AlertDialog.Header>
          ...
          <AlertDialog.Description
            >Are you sure about that? Double check provided information if necessary.</AlertDialog.Description
          >
        </AlertDialog.Header>
        <AlertDialog.Footer>
